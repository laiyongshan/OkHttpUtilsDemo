package com.yeohe.myokhttpapplication;
...
import com.yeohe.myokhttpapplication.sample_okhttp.ListUserCallback;
import com.yeohe.myokhttpapplication.sample_okhttp.URLs;
import com.yeohe.myokhttpapplication.sample_okhttp.User;
...
public class MainActivity extends AppCompatActivity
{
    ...
    //get方式提交键值对数据
    public void getWithParams(String url,HashMap map) {
//        String url = mBaseUrl + "app/news/index.php";
        OkHttpUtils.get().url(url).id(100).params(map).build().execute(new MyStringCallback());
    }
...
//        String url = mBaseUrl + "user/loginv2.php";
        ...
        String url=URLs.GET_REGISTER_CITY;
        ...
        OkHttpUtils.post().url(url).params(map).build().execute(new StringCallback() {
            ...
            public void onAfter(int id) {
                mTv.append("onAfter...");
                Toast.makeText(MainActivity.this,"onAfter....",Toast.LENGTH_LONG).show();
            }
